...
<head>
    ...
    <title>Bandicalia — Registro banda</title>
    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                <h1 class="font-serif text-3xl font-extrabold text-cream mb-2">Crea el perfil de tu banda</h1>
                <p class="text-white/50 text-sm">Rellena los datos básicos. Podrás completar el perfil después.</p>
            </div>

            <form method="POST" action="{{ route('register.band.store') }}" class="space-y-5">
                @csrf

                <!-- Nombre de la banda -->
                <div>
                    <label for="name" class="block text-sm font-medium text-white/70 mb-1">Nombre de la banda</label>
